...
\begin{proof}
    ...
    \bu{Case 1.} $G$ is abelian. Follows from the \hyperref[thm: structural theorem]{structural theorem for finite abelian groups}: $G$ is isomorphic to a product of groups where one of them is $\Z/p^m\Z$ for $m \in \Z_{>0}$. This gives an element with order $p$.
    ...
    \bu{Case 2.} $G$ is not necessarily abelian. Argue by induction on the order of the group:
    \begin{itemize}

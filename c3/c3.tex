...
\begin{theorem}\label{thm: algebraic extension can be extended to algebraically closure}
    Given two field extensions $k \ext K$ and $k \ext L$ s.t. $K/k$ is algebraic, and $L$ is algebraically closed. Then there is a morphism of $k$-extensions (as $k$-algebras) $K \ext L$.
\end{theorem}

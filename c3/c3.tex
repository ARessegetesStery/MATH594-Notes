...
\begin{proposition}
    A subset $A \subseteq L$ is a maximal algebraically independent subset over $k$ of $K$ if $A$ is algebraically independent, and $k(A) \ext K$ is an algebraic extension. 
\end{proposition}
